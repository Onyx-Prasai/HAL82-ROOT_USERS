...
const VisionPage = () => {
    ...
    return (
        <div className="bg-sangam-slate text-white">
            ...
            <section className="min-h-screen flex flex-col items-center justify-center bg-white text-sangam-slate p-8">
            ...
            {/* Step 3: The Impact */}
            <section className="min-h-screen flex flex-col items-center justify-center p-8 bg-slate-50 text-sangam-slate">
                <h3 className="text-4xl font-bold mb-16">History of Growth</h3>
                <div className="max-w-4xl w-full relative">
                    <div className="absolute left-1/2 -translate-x-1/2 h-full w-1 bg-slate-200"></div>
            ...
            <footer className="py-20 bg-sangam-slate text-center">
                <h2 className="text-3xl font-bold mb-8">Ready to join the confluence?</h2>
                <button className="bg-sangam-emerald text-white px-10 py-4 rounded-2xl font-bold text-xl hover:scale-105 transition-all">
                    Get Started
                </button>
            </footer>
        </div>
...
const TimelineItem = ({ year, event, side }) => (
    ...
    >
        ...
        <div className="w-4 h-4 rounded-full bg-sangam-emerald shadow-lg shadow-emerald-200 relative z-10"></div>
        <div className={`w-1/2 p-6 ${side === 'left' ? 'text-right' : 'text-left'}`}>
            <span className="text-sangam-emerald font-black text-xl">{year}</span>
            <p className="text-lg font-bold text-sangam-slate mt-1">{event}</p>
        </div>
    </motion.div>
);
